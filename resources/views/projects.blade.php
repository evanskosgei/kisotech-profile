                    ...
                    <div class="navbar-nav mx-0 mx-lg-auto">
                        ...
                        <div class="nav-item dropdown active">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a href="/projects" class="dropdown-item active">Our Projects</a>
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.2s">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-8 col-lg-8 col-xl-9">
                            <div class="d-flex flex-column my-auto text-start p-4">
                                <h4 class="text-dark mb-0">Remittance System</h4>
                                <p class="mb-0">We have developed a state-of-the-art remittance system that enables
                                    users to send and receive money across the globe seamlessly. Our platform is
                                    designed to provide fast, secure, and reliable transactions, ensuring that funds are
                                    delivered quickly and efficiently, no matter where they are needed. With our
                                    commitment to innovation and customer satisfaction, we are proud to offer a solution
                                    that simplifies the remittance process for individuals and businesses alike.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="testimonial-item bg-light rounded">
                    <div class="row g-0">
                        ...
                        <div class="col-8 col-lg-8 col-xl-9">
                            <div class="d-flex flex-column my-auto text-start p-4">
                                <h4 class="text-dark mb-0">Enterprise Resource Planning</h4>
                                <p class="mb-0"> We offers a robust Enterprise Resource Planning (ERP) system
                                    designed
                                    to streamline business operations and enhance productivity. Our ERP solution
                                    integrates various functions such as finance, supply chain management, and human
                                    resources into a single cohesive platform. This allows businesses to make informed
                                    decisions based on real-time data, optimize resource allocation, and improve overall
                                    efficiency.
                                </p>
                            </div>
                        </div>
                ...
                <div class="testimonial-item bg-light rounded">
                    <div class="row g-0">
                        ...
                        <div class="col-8 col-lg-8 col-xl-9">
                            <div class="d-flex flex-column my-auto text-start p-4">
                                <h4 class="text-dark mb-0">Ventie KE</h4>
                                <p class="mb-0">Ventie KE is a comprehensive social event management system designed
                                    to
                                    enhance your event experience. With a focus on seamless social interaction, our
                                    platform offers features that enable users to create, manage, and promote events
                                    effortlessly. It includes integrated payment solutions and ticketing options,
                                    allowing attendees to purchase tickets and access events with ease. Ventie KE
                ...
                <div class="testimonial-item bg-light rounded">
                    <div class="row g-0">
                        <div class="col-4  col-lg-4 col-xl-3">
                            <div class="h-100">
                                <img src="img/testimonial-4.jpg" class="img-fluid h-100 rounded"
                                    style="object-fit: cover;" alt="">
                            </div>
                        </div>
                        <div class="col-8 col-lg-8 col-xl-9">
                            <div class="d-flex flex-column my-auto text-start p-3">
                                <h4 class="text-dark mb-0">Anony AID</h4>
                                <p class="mb-0">Anony Aid is a therapy system that empowers clients to book therapy
                                    sessions with their favorite therapists seamlessly. This not only facilitates
                                    bookings but also creates a supportive community where users can share their
                                    personal journeys and experiences. It prioritizes privacy and inclusivity, ensuring
                                    that everyone has a safe space to discuss their mental health and well-being. It
                                    aims to enhance your mental health through professional support and community
                                    engagement.
                                </p>
                            </div>
                        </div>
